...
<Meta title="Documentation/Voice and tone" />
...
You’re looking at ownCloud Design System’s demo <code>voice & tone</code>. Everything you see here is editable in Markdown format. To change or remove this content, see [/docs/voice-and-tone.md](https://github.com/owncloud/owncloud-design-system/blob/master/docs/voice-and-tone.md). 

...
.button {
  ...
  border: 0;
  box-shadow: inset 0 0 0 2px $color-oc_blue;
  ...
  &.hover {
    color: $color-white;
    background: $color-oc_blue;
    transform: translateZ(0) scale(1.03);
  }
  &:active,
  &.active {
    transition: none;
    background: $color-oc_blue-dark;
    box-shadow: none;
    color: $color-white;
  ...
  &:focus,
  &.focus {
    background: $color-oc_blue-darker;
    box-shadow: none;
    color: $color-white;
    transform: translateZ(0) scale(1);
    outline: 0;
  ...
  &.primary {
    ...
    &:hover,
    &.hover {
      background-color: shade($color-oc_blue, 12%);
    }
    &:active,
    &.active {
      background-color: shade($color-oc_blue, 20%);
      transition: none;
    }
    &:focus {
      outline: 0;

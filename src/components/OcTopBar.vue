...
<template>
  <div>
    <oc-topbar variation="primary">
      <oc-topbar-logo icon="menu" title="Files" slot="left" @click="onClick" accessible-label="Open files menu"></oc-topbar-logo>
      ...
      <oc-topbar-item slot="right">
        <oc-icon name="account_circle" color="white" accessible-label="Open account settings"></oc-icon>
        <span>Alice</span>
      </oc-topbar-item>
    </oc-topbar>
    <oc-topbar variation="secondary">
      <template slot="left">
        <oc-topbar-logo icon="home" accessible-label="Go to root folder"></oc-topbar-logo>

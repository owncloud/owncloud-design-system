...
describe("OcTextInput", () => {
  ...
  describe("when error message is provided", () => {
    ...
    it("should add error class to input message", () => {
      expect(wrapper.find(selectors.textInputMessage).attributes().class).toContain(
        "oc-text-input-danger"
      )
    })
    it("should show the error message as input message text", () => {
      expect(wrapper.find(selectors.textInputMessage).text()).toBe("You shall not pass.")
    })
    it("should set input aria-invalid as true", () => {
  ...
  describe("type prop", () => {
    it("should not allow types other than text, number, email and password", () => {
      try {
    ...
    it.each(["text", "number", "email", "password"])(
      "should set provided type for the input",
      type => {
  ...
  describe("clear button accessible label prop", () => {
    it("should set aria label of clear input button if provided", () => {
      const wrapper = getShallowWrapper({

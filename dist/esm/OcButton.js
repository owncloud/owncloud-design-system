import { openBlock, createBlock, resolveDynamicComponent, withCtx, createCommentVNode, renderSlot } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(resolveDynamicComponent($props.type), {
    href: $props.href,
    to: $props.to,
    type: $props.submit,
    ...
    default: withCtx(function () {
      return [createCommentVNode(" @slot Content of the button "), renderSlot(_ctx.$slots, "default")];
    }),
    _: 3
    /* FORWARDED */
